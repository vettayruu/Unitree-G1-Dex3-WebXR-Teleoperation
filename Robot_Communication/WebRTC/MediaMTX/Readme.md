...
On Ubuntu
```bash
ffmpeg -f v4l2 -input_format mjpeg -video_size 2800x1400 -framerate 30 -i /dev/video0 \
  -vf "format=nv12" \
  -c:v h264_nvenc -b:v 10M -g 30 -preset p5 -tune ll -rc vbr \
  -f rtsp -rtsp_transport tcp rtsp://192.168.123.235:8554/g1-vr180
```
