...
export default function RobotScene(props) {
  ...
  const handleCompleteCurrentTask = () => {
    ...
    setTaskMsg(`Task ${activeTaskId} accomplished.`);
  ...
  return (
    <>
      ...
      >
        ...
        {/* SAP Menu */}
        {showMenu && (
          <a-entity id="task" position="-1.0 0.8 -1.2" rotation="0 37 0">
            ...
            <a-entity id="data-section" position="-0.05 0.065 0.02">
            ...
            >
                ...
                <a-text value="Task"    position="-0.50 0 0.01" width="1" font={font_path} color="#00c8ff"></a-text>
                <a-text value="Product" position="-0.13 0 0.01" width="1" font={font_path} color="#00c8ff"></a-text>
                <a-text value="Action"  position="0.36 0 0.01"  width="1" font={font_path} color="#00c8ff"></a-text>

                {/* 展开/收起箭头指示 */}
                {/* <a-text
                value={dropdownOpen ? "open" : "next"}
                position="0.60 0 0.01"
                width="1"
                font={font_path}
                color="#00c8ff"
                ></a-text> */}
            ...
            {(() => {
                ...
                const barRadius = barHeight / 2; // 完全圆润的两端
                ...
                return (
                    <a-entity position="-0.025 -0.65 0.02">
            ...
            <a-entity position="0.0 -0.86 0.0" >
                <a-entity
                id="sap-data-start"
                position="-0.43 0.08 0.01"
                ...
                <a-entity
                key={`complete-btn-${canComplete}`} 
                id="sap-data-complete"
                position="0.39 0.08 0.01"
                class={canComplete ? "raycastable menu-button" : "menu-button"}
                geometry={`primitive: rounded-rect; width: 0.38; height: 0.135; radius: 0.02`}
                rounded-rect-border={`width: 0.38; height: 0.135; radius: 0.02; color: ${canComplete ? '#ffffff' : '#3e3e3e'}`}
                material={`color: ${canComplete ? '#333' : '#1a1a1a'}; opacity: 0.95; shader: flat`}
                ...
                {/* Message */}
                <a-entity id="btp_message" position="-0.020 -0.12 0.01" 
                geometry={`primitive: rounded-rect; width: 1.21; height: 0.18; radius: 0.01`}
                material="color:rgb(93, 173, 253); opacity: 0.95"
                ><a-text value={task_msg || "No Message"} align="center" color="#fff" width="1.0" position="0 0 0.01" font={font_path}></a-text>
                </a-entity>
            </a-entity>
