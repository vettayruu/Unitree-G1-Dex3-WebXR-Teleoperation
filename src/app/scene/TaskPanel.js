...
import RobotSettingsPanel from './RobotSettingsPanel.js';
...
export default function TaskPanel(props) {
  ...
  return (
    <>
        {/* FixPanel */}
        <FixPanel {...props} font_path={font_path} activeTaskId={activeTaskId} activeProductId={activeProductId} completedTaskIds={completedTaskIds} />

        {/* Robot Setting */}
        {showRobotSetting && showMenu && (
          <RobotSettingsPanel setShowRobotSetting={setShowRobotSetting}
              botton_width={botton_width} font_path={font_path} />
        )}
