...
ROBOT_UUID = os.getenv("ROBOT_UUID","2A5PE-YUSHU008-SIM")
        ...
        if msg.topic == self.MQTT_TIME_PONG_TOPIC:
            try:
                ...
                if t0 and server_time:
                    ...
                    print(
                        f"⏱️ [TIME SYNC SUCCESS] 单程延时(RTT/2): {network_delay}ms, 本地时间偏差(Offset): {self.time_offset}ms")
